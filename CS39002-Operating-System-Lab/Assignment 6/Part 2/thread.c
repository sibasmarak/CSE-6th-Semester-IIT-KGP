...
thread_init (void) 
{
  ...
  initial_thread->fd = 2;//0, 1 reserved for stdin & stdout
  //initiliaze list of files held by this thread
  list_init(&initial_thread->file_list);
  //initialize executable file to NULL
               ...
               thread_func *function, void *aux) 
{
  ...
  */
  ...
  t->fd = 2;//0, 1 reserved for stdin & stdout
  //initiliaze list of files held by this thread
